...
<section class="content-header">
  <h1>
	<?php echo lang('msg_playlists'); ?>
	<small><?php echo lang('msg_edit_playlists'); ?></small>
  </h1>
  <ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#"><?php echo lang('msg_dashboard'); ?></a></li>
	<li><a href="#"><?php echo lang('msg_playlists'); ?></a></li>
	<li class="active"><?php echo lang('msg_edit_playlists'); ?></li>
...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo lang('msg_edit_playlists'); ?></h3>
        </div>
	...
	;?>
	<form class="form-horizontal" id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url().'admin/playlists/edit_post';?>">

		<input type="hidden" name="id" id="id" value="<?php echo $obj[0]->id;?>">
		<input type="hidden" name="path" value="<?php echo $obj[0]->image ?>">
