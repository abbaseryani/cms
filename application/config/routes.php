...
$route['detail_gif']='home/detail_gif';
...
$route['admin/artists/(:num)']='admin/artists/index/$1';
$route['admin/playlists/(:num)']='admin/playlists/index/$1';
$route['admin/albums/(:num)']='admin/albums/index/$1';
$route['admin/contact/(:num)']='admin/contact/index/$1';
$route['admin/audios/(:num)']='admin/audios/index/$1';
