...
function rename_logo_app_name($file_name){
    return 'app_logo.'.pathinfo($file_name, PATHINFO_EXTENSION);   
}

function rename_push_image($file_name){
    return 'app_push_image.'.pathinfo($file_name, PATHINFO_EXTENSION);   
}
